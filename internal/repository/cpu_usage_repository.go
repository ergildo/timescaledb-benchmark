...
type CpuUsageRepository interface {
	...
	SearchByParams(hostname string, startTime, endTime *time.Time) (*model.CpuUsage, error)
}
...
func (r cpuUsageRepositoryImpl) SearchByParams(hostname string, startTime, endTime *time.Time) (*model.CpuUsage, error) {
